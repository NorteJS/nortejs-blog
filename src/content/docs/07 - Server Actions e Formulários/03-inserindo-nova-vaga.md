...
Claro que ainda falta melhorar o feedback para o usuário, mas já temos aqui uma DX (_developer experience_) muito boa - duas linhas de código para gerenciar um formulário com mais de uma dezena de campos.
