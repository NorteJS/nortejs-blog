...
Para isso, o primeiro passo é, ao invés de lançarmos um erro em nossa _action_, é retornarmos o erro. Vamos, então, alterar a nossa action em dois lugares
...
O _hook_ `useActionState()` é o recomendado pelo Next.js para feedbacks instantâneos e client-side. A assinatura dele é a seguinte:
