...
Para isso, vamos criar uma rota dinâmica. Uma rota dinâmica é uma rota "_catch-all_", ou seja, pega tudo.
...
Veja que a partir de agora, quando acessamos a rota `/vagas/qualquer-coisa`, não temos mais um erro 404, mas sim renderizamos nosso _hello world_.

E mais, conseguimos pegar o segmento de rota passado com o nome que foi dado à pasta. No nosso caso como a pasta se chama `[id]`, nosso segmento chegará dentro de `params.id` como _prop_ na nossa página
