...
Vamos começar? Antes de mais nada, um overview do que iremos tratar no Workshop de hoje. Vamos em todo o workshop utilizar uma única aplicação de _job board_ (que se chamará VagasNorteJs) e que será completamente feita com `Next.Js`.

Se você não consegue esperar, já pode ir olhando no nosso Figma para ver a aplicação que será construída. O <a href="https://www.figma.com/design/eUNA2DgrQeB4TkTbnLbBMI/Vagas-NorteJS?node-id=0-1&t=y7IWQPTKTur3VXtF-1" target="_blank">link é esse</a>.
...
- Os nomes _reservados_ do roteamento no `Next.js`.
- Criando as páginas do _VagasNorteJs_
  - Home Page
